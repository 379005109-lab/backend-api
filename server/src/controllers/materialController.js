...
// 批量删除素材
export const batchDeleteMaterials = async (req, res, next) => {
  try {
    const { ids } = req.body
...
// 审核素材
export const reviewMaterial = async (req, res, next) => {
  try {
...
// 获取素材分类列表
export const getAllMaterialCategories = async (req, res, next) => {
  try {
...
// 获取素材分类树
export const getMaterialCategoryTree = async (req, res, next) => {
  try {
...
// 创建素材分类
export const createMaterialCategory = async (req, res, next) => {
  try {
...
// 更新素材分类
export const updateMaterialCategory = async (req, res, next) => {
  try {
...
// 删除素材分类
export const deleteMaterialCategory = async (req, res, next) => {
  try {
